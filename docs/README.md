...
| 理解整体架构与安全边界 | [Project Core](architecture/PROJECT_CORE.md) / [Permission & Sandbox](architecture/PERMISSION_PATH_SANDBOX.md) / [Workspace](architecture/WORKSPACES.md) |
...
2. 核心组件、权限、Workspace、任务和 Executor 设计放入 `architecture/`。
